...
//	Constructor 
//
OleEnumFormatEtc::OleEnumFormatEtc(FORMATETC *pFormatEtc, int nNumFormats)
{
	m_lRefCount   = 1;
	m_nIndex      = 0;
...
//	IUnknown::AddRef
//
ULONG __stdcall OleEnumFormatEtc::AddRef(void)
{
...
//	IUnknown::Release
//
ULONG __stdcall OleEnumFormatEtc::Release(void)
{
...
//
HRESULT __stdcall OleEnumFormatEtc::QueryInterface(REFIID iid, void **ppvObject)
{
...
//
HRESULT __stdcall OleEnumFormatEtc::Next(ULONG celt, FORMATETC *pFormatEtc, ULONG * pceltFetched)
{
	ULONG copied  = 0;
...
//	IEnumFORMATETC::Skip
//
HRESULT __stdcall OleEnumFormatEtc::Skip(ULONG celt)
{
	m_nIndex += celt;
...
//
HRESULT __stdcall OleEnumFormatEtc::Reset(void)
{
	m_nIndex = 0;
	return S_OK;
}
...
//
HRESULT __stdcall OleEnumFormatEtc::Clone(IEnumFORMATETC ** ppEnumFormatEtc)
{
	HRESULT hResult;
