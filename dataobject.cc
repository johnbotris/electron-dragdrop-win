...
//	IUnknown::AddRef
//
ULONG __stdcall OleDataObject::AddRef(void)
{
...
//	IUnknown::Release
//
ULONG __stdcall OleDataObject::Release(void)
{
...
//
HRESULT __stdcall OleDataObject::GetDataHere (FORMATETC *pFormatEtc, STGMEDIUM *pMedium)
{
...
//
HRESULT __stdcall OleDataObject::GetCanonicalFormatEtc (FORMATETC *pFormatEct, FORMATETC *pFormatEtcOut)
{
...
//	IDataObject::SetData
//
HRESULT __stdcall OleDataObject::SetData (FORMATETC *pFormatEtc, STGMEDIUM *pMedium,  BOOL fRelease)
{
	return E_NOTIMPL;
}
...
//	IDataObject::DAdvise
//
HRESULT __stdcall OleDataObject::DAdvise (FORMATETC *pFormatEtc, DWORD advf, IAdviseSink *pAdvSink, DWORD *pdwConnection)
{
...
//
HRESULT __stdcall OleDataObject::DUnadvise (DWORD dwConnection)
{
	return OLE_E_ADVISENOTSUPPORTED;
}
...
//
HRESULT __stdcall OleDataObject::EnumDAdvise (IEnumSTATDATA **ppEnumAdvise)
{
	return OLE_E_ADVISENOTSUPPORTED;
}
...
HRESULT CreateDataObject (FORMATETC *fmtetc, STGMEDIUM *stgmeds, UINT count, IDataObject **ppDataObject)
{
	...
	*ppDataObject = new OleDataObject(fmtetc, stgmeds, count);
